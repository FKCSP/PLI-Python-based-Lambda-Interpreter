...
_lr_productions = [
  ...
  ('expr -> ID','expr',1,'p_expr_ID','yacc.py',45),
  ('expr -> NAT','expr',1,'p_expr_NAT','yacc.py',52),
  ('expr -> IF ( expr ) THEN expr ELSE expr','expr',8,'p_expr_if','yacc.py',59),
  ('expr -> ( expr )','expr',3,'p_expr_paren','yacc.py',70),
  ('expr -> LAMBDA ID . expr ( expr )','expr',7,'p_expr_function_app','yacc.py',77),
  ('expr -> LAMBDA ( ID . expr )','expr',6,'p_expr_function_abs','yacc.py',84),
  ('expr -> REC ID . LAMBDA ID . expr','expr',7,'p_expr_recursive','yacc.py',91),
  ('expr -> expr PLUS expr','expr',3,'p_expr_arith','yacc.py',98),
  ('expr -> expr MINUS expr','expr',3,'p_expr_arith','yacc.py',99),
  ('expr -> expr TIMES expr','expr',3,'p_expr_arith','yacc.py',100),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr_arith','yacc.py',101),
  ('expr -> expr MOD expr','expr',3,'p_expr_arith','yacc.py',102),
  ('expr -> expr LT expr','expr',3,'p_expr_comparisons','yacc.py',121),
  ('expr -> expr LE expr','expr',3,'p_expr_comparisons','yacc.py',122),
  ('expr -> expr GT expr','expr',3,'p_expr_comparisons','yacc.py',123),
  ('expr -> expr GE expr','expr',3,'p_expr_comparisons','yacc.py',124),
  ('expr -> expr EQ expr','expr',3,'p_expr_comparisons','yacc.py',125),
  ('expr -> expr NEQ expr','expr',3,'p_expr_comparisons','yacc.py',126),
  ('expr -> MINUS expr','expr',2,'p_expr_UMINUS','yacc.py',143),
  ('expr -> PLUS expr','expr',2,'p_expr_UPLUS','yacc.py',148),
]
